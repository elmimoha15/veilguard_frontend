...
import { useCallback, useEffect, useMemo, useRef, useState, memo, type CSSProperties, type ReactNode, type Key, type RefObject } from 'react';

/** LogoLoop (React Bits) — an infinite marquee of logos. Styles live in globals.css. */

type NodeLogo = { node: ReactNode; title?: string; href?: string; ariaLabel?: string };
type ImageLogo = { src: string; srcSet?: string; sizes?: string; width?: number; height?: number; alt?: string; title?: string; href?: string };
...
const useImageLoader = (seqRef: RefObject<HTMLUListElement | null>, onLoad: () => void, dependencies: unknown[]) => {
  useEffect(() => {
