...
export const BUILDER_QUESTIONS: Article[] = [
  // 1 ────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      {
        ...
        href: '/guides/supabase-row-level-security-explained-for-non-developers',
      },
      {
        label: 'How do I know if my Supabase database is exposed?',
        href: '/security/how-do-i-know-if-my-supabase-database-is-exposed',
      },
      {
    ...
    builder: { label: 'Scan your Lovable app free', href: '/scanners/lovable' },
    ...
    related: [
      {
        ...
        href: '/security/how-to-check-for-exposed-api-keys',
      },
      {
        label: 'How do I know if my Supabase database is exposed?',
        href: '/security/how-do-i-know-if-my-supabase-database-is-exposed',
      },
      {
        ...
        href: '/scanners/lovable',
      },
    ],
    builder: { label: 'Scan your Bolt app free', href: '/scanners/bolt' },
  },
  ...
  // 3 ────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      ...
      },
      {
        ...
        href: '/guides/are-ai-generated-apps-safe-to-launch',
      },
    ],
    builder: { label: 'Scan your Cursor app free', href: '/scanners/cursor' },
  },
  ...
  // 4 ────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      ...
      },
      {
        ...
        href: '/guides/is-it-safe-to-take-payments-on-a-vibe-coded-app',
      },
    ],
    builder: { label: 'Scan your Replit app free', href: '/scanners/replit' },
    hasPlaceholders: true,
  },
  ...
  // 5 ────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      ...
      },
      {
        ...
        href: '/scanners/cursor',
      },
    ],
    builder: { label: 'Scan your v0 app free', href: '/scanners/v0' },
  },
];
